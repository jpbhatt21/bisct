...
import { AppWindowIcon, LayoutDashboardIcon, Projector, SettingsIcon, TerminalIcon } from "lucide-react";
import { io } from "socket.io-client";
export const store = createStore();
export const projectsAtom= atom([] as any[]);
export const navigatorAtom = atom({
	trigger: false,
	path: "",
	replace: false,
});
export const bearerAtom = atom(null as string | null);
export const sidebarOptions = [
	{
		name: "Dashboard",
		icon: <LayoutDashboardIcon className="h-5 -mt-0.5"/>,
	},
  {
		name: "Projects",
		icon: <AppWindowIcon className="h-5 -mt-0.5"/>,
	},
	{
		name: "Terminal",
		icon: <TerminalIcon className="h-5 -mt-0.5"/>,
	},
	{ name: "Settings", icon: <SettingsIcon className="h-5 -mt-0.5"/> },
];
export const socket =io();
export const svg = {
	cookie: (
		<svg fill="currentColor" height="25" width="25" className="aspect-square" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xmlSpace="preserve">
